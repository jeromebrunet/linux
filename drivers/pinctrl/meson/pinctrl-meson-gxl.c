...
static struct meson_bank meson_gxl_periphs_banks[] = {
	...
	BANK("X",    PIN(GPIOX_0, EE_OFF),	PIN(GPIOX_18, EE_OFF),   88, 106, 4,  0,  4,  0,  12, 0,  13, 0,  14, 0),
	...
	BANK("CLK",  PIN(GPIOCLK_0, EE_OFF),	PIN(GPIOCLK_1, EE_OFF), 107, 108, 3, 28,  3, 28,  9, 28, 10, 28, 11, 28),
};
